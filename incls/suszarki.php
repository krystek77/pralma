...
if ($this->exists) {
    ...
    <div class="models">
        ...
        <ul class="model-list clearfix">
            ...
            <li><a class="scrollUp" href="javascript:void(null)" onclick="insertInfo('suszarki/SE_SP_16_25_35_R')" title="Suszarka bębmowa ,podgrzew elektryczny, Pralma">SE 25R</a></li>
            <li><a class="scrollUp" href="javascript:void(null)" onclick="insertInfo('suszarki/SE_SP_16_25_35_R')" title="Suszarka bębmowa ,podgrzew elektryczny, Pralma">SE 35R</a></li>
            ...
            <li><a class="scrollUp" href="javascript:void(null)" onclick="insertInfo('suszarki/T_11_13_16')" title="Suszarka bębmowa, Primus">T 16</a></li>
            <li><a class="scrollUp" href="javascript:void(null)" onclick="insertInfo('suszarki/T_9_HP')" title="Suszarka bębmowa, z pompą ciepła, Primus">T 9 HP</a></li>
            <li><a class="scrollUp" href="javascript:void(null)" onclick="insertInfo('suszarki/T_11_13_16_HP')" title="Suszarka bębmowa, z pompą ciepła, Primus">T 11 HP</a></li>
            <li><a class="scrollUp" href="javascript:void(null)" onclick="insertInfo('suszarki/T_11_13_16_HP')" title="Suszarka bębmowa, z pompą ciepła, Primus">T 13 HP</a></li>
            <li><a class="scrollUp" href="javascript:void(null)" onclick="insertInfo('suszarki/T_11_13_16_HP')" title="Suszarka bębmowa, z pompą ciepła, Primus">T 16 HP</a></li>
            <li><a class="scrollUp" href="javascript:void(null)" onclick="insertInfo('suszarki/TAMS_13')" title="Suszarka bębmowa, Primus">TAMS 13</a></li>
            ...
            <li><a class="scrollUp" href="javascript:void(null)" onclick="insertInfo('suszarki/DX_24_25_34')" title="Suszarka bębmowa, Primus">DX 24</a></li>
            <li><a class="scrollUp" href="javascript:void(null)" onclick="insertInfo('suszarki/DX_24_25_34')" title="Suszarka bębmowa, Primus">DX 25</a></li>
            ...
            <li><a class="scrollUp" href="javascript:void(null)" onclick="insertInfo('suszarki/DAM_6')" title="Suszarka bębmowa, Primus">DAM6</a></li>
            <li><a class="scrollUp" href="javascript:void(null)" onclick="insertInfo('suszarki/SD_10')" title="Suszarka bębmowa, Primus">SD 10</a></li>
            <li><a class="scrollUp" href="javascript:void(null)" onclick="insertInfo('suszarki/SDH_10')" title="Suszarka bębmowa, z pompą ciepła, Primus">SDH 10</a></li>
            <li><a class="scrollUp" href="javascript:void(null)" onclick="insertInfo('suszarki/SDS_10')" title="Suszarka bębmowa,zestaw suszący, Primus">SDS 10</a></li>
            <li><a class="scrollUp" href="javascript:void(null)" onclick="insertInfo('suszarki/komorowe/DC_4')" title="Suszarka komorowa, Primus">DC 4</a></li>
            <li><a class="scrollUp" href="javascript:void(null)" onclick="insertInfo('suszarki/komorowe/DC_8')" title="Suszarka komorowa, Primus">DC 8</a></li>
            <li><a class="scrollUp" href="javascript:void(null)" onclick="insertInfo('suszarki/komorowe/DC_8_HP')" title="Suszarka komorowaz pompą ciepła, Primus">DC 8 HP</a></li>
            <li><a class="scrollUp" href="javascript:void(null)" onclick="insertInfo('suszarki/komorowe/DC_16')" title="Suszarka komorowa, Primus">DC 16</a></li>
            <li><a class="scrollUp" href="javascript:void(null)" onclick="insertInfo('suszarki/komorowe/FDC')" title="Suszarka komorowa dla straży pożarnej i suszenia ciężkiej odzieży ochronnej, Primus">FDC</a></li>
        </ul>
    </div>
<?php
} else {
